...
def delete_profile_user(sender, instance, **kwargs):
    ...
    #---------------------add delete log-----------------------
    new_log = Log()
    new_log.description = f"profile with id {instance.id} and username {instance.user.username} deleted by {request.user} with id {request.user.id} in"
    new_log.save()
    #--------------------/add delete log-----------------------
...
def log_create_profile_user(sender, instance, **kwargs):
    ...
    #---------------------add delete log-----------------------
    new_log = Log()
    new_log.description = f"profile with id {instance.id} and username {instance.user.username} created by {request.user} with id {request.user.id} in"
    new_log.save()
    #--------------------/add delete log-----------------------
